					...
					<section id="registerForm" style="padding:0 10px;">
						...
						<div class="row">
							<div class="col-md-12 wow fadeIn animated" data-wow-duration="1.5s" data-wow-delay="1s">
								...
								<a class='btn btn-lg btn-danger font-semibold text-right second_color_btn' id="submitform" href='#' style="width:243px; background-color: #fed405; font-size:1em; color:#000;border-radius:7px; border: 0px;" data-toggle="tooltip" title="If you are an existing EstateBaron.com user you can use the same username and password here without having to sign up again"><img class="pull-left" src="{{asset('assets/images/estatebaronLogo.png')}}" style="width: 20px;"> Register</a>
							</div>
						</div>
						{!! Form::close() !!}
						<br>
