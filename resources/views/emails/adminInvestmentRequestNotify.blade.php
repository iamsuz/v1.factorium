...
<head>
  ...
  <title>Investment Request Email</title>
                            ...
                            <tbody><tr>
                              <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;"><br> <br>
                                ...
                                <div style="font-size: 13px;text-align:justify; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
                                  <span style="color:#000"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px; color: #000;">User requested for help in filling investment form. Below are the details:<br><br>
                                  <span style="font-family:helvetica; font-weight:lighter; line-height:21px; color:#000;"><b>User Name: </b>{{$user->first_name}} {{$user->last_name}}</span><br>
                                  <span style="font-family:helvetica; font-weight:lighter; line-height:21px; color:#000;"><b>Email: </b>{{$user->email}}</span><br>
                                  <span style="font-family:helvetica; font-weight:lighter; line-height:21px; color:#000;"><b>Phone Number: </b>{{$user->phone_number}}</span><br>
                                  <span style="font-family:helvetica; font-weight:lighter; line-height:21px; color:#000;"><b>Project Name: </b>{{$project->title}}</span><br><br><br>
                                  <a href="{{$formLink}}" style="font-family:helvetica; font-weight:lighter; line-height:21px; color:#fff;text-decoration:none;padding:15px;cursor:pointer; background-color: @if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors())#{{$siteColor->heading_color}}@else #282a73 @endif"><b>Fill Investment Form</b></a><br><br>
