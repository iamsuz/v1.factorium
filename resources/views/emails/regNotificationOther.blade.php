...
<span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">The following user has joined Vestabyte using @if($investor->social_accounts) {{$investor->social_accounts[0]->provider}} @else Vestabyte platform @endif<br>
<br>
