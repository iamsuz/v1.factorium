      ...
      <tr>
        <td align="center" valign="top" id="bodyCell" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;height: 100%;margin: 0;padding: 10px;width: 100%;border-top: 0;">
          <!-- BEGIN TEMPLATE // -->
            ...
            <![endif]-->
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;border: 0;max-width: 800px !important;">
              <tr>
                        ...
                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                          <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px;padding-left: 0px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: @if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors())#{{$siteColor->nav_footer_color}}@else #2D2D4B @endif;">
                              ...
                              <!-- <img align="center" alt="" src="http://www.vestabyte.com/assets/images/email/vb.png" width="800" style="max-width: 650px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" class="mcnImage"> -->
            ...
            <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;">
              ...
              <div style="font-size: 13px;text-align:left; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
                <span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">We received a New Receivable from {{$investor['first_name']}}, following are all the details.<br>
                  <br>
                  <table style="width: 100%;border-right:none; border-left: none; " border='1' >
                    <tbody style="border-right:none; border-left: none; ">
                      <tr style=" padding: 2em 0px;">
                        <td style="width: 50%; border-right: none; border-left: none; padding: 2em 0px;" >
                        Name: <b><span >{{$investor['first_name']}} {{$investor['last_name']}}</span></b><br><br>
                        Email: <b><span >{{$investor['email']}}</span></b><br><br>
                        Phone Number: <b><span >{{$investor['phone_number']}}</span></b><br><br>
                        Receivable Name: <b><span >{{$project['title']}}</span></b><br><br>
                        Amount: <b><span >{{$investmentDetails['total_projected_costs']}}</span></b>
                      </td>
                      <td style="width: 50%;border-right:none; border-left: none;">
                        Asking price: <b><span >{{$investmentDetails['goal_amount']}}</span></b><br><br>
                        Invoice due date: <b><span >{{date('d-m-Y', strtotime($investmentDetails['fund_raising_close_date']))}}</span></b><br><br>
                        Invoice issued to: <b><span >{{$project['description']}}</span></b><br><br>
                        Invoice issued to Email: <b><span >{{$project['invoice_issue_from_email']}}</span></b><br><br>
                        Invoice issued from: <b><span >{{$project['invoice_issued_from']}}</span></b>
                      </td>
                      </tr>
                    </tbody>
                  </table>
