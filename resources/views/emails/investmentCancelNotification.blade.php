...
<head>
  ...
  <title>Investment Cancel Email</title>
                            ...
                            <tbody><tr>
                              <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;"><br> <br>
                                ...
                                <div style="font-size: 13px;text-align:justify; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
                                  <span style="color:#000"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">This is to let you know that your previously issued {{$investment->amount}} @if($investment->project->share_vs_unit) shares @else units @endif in @if($investment->project->projectspvdetail){{$investment->project->projectspvdetail->spv_name}}@else Estate Baron @endif numbered {{$shareStart}} to {{$shareEnd}} in the name of {{$investment->user->first_name}} {{$investment->user->last_name}} have been cancelled.<br><br>
                                    <span style="color:#000">If you believe this was done in error, please let us know by replying on this email @if($investment->project->projectspvdetail) or calling us at {{$investment->project->projectspvdetail->spv_contact_number}}@endif. <br><br><br>
