            ...
            <tr>
                <td valign="top" style="padding: 0px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="mcnImageBlockInner">
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px;padding-left: 0px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: @if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors($user->registration_site))#{{$siteColor->nav_footer_color}}@else #2D2D4B @endif;">
                                        ...
                                        {{-- <p style="font-family:helvetica; font-weight:bolder; text-align: left; padding-left: 18px; color: #fff; font-size: 25px;">@if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif</p> --}}
                                        <table  border="0" cellpadding="18" cellspacing="0" align="left"> 
                                          <td style="font-family:helvetica; font-weight:bolder; text-align: left; color: #fff; font-size: 25px;" cell-padding="18">@if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif</td>
                                       </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;">
                            ...
                            <br> <br>
<strong><span style="color:@if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors($user->registration_site))#{{$siteColor->heading_color}}@else #282a73 @endif"><span style="font-family:helvetica; font-weight:bolder; line-height:21px"><span style="font-size:20px"></span></span></span></strong>

<div style="font-size: 13px;text-align:left; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
<span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">Hi there, you’re nearly done with completing your account registration. Simply click this link and you’re done!<br>
<br></span></span></span>
&nbsp;</div>
...
<span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">Cheers,<br>
                            <br><span style="color:@if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors($user->registration_site))#{{$siteColor->heading_color}}@else #282a73 @endif"><span style="font-size:16px"><span style="font-family:helvetica; font-weight:bold; line-height:21px">Team @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif<br><br>
                        </td>
                    </tr>
                </tbody></table>
        <!--[if mso]>
...
The advice provided in relation to the @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif Platform,
including on the @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif Platform website,
is general advice only and has been prepared without taking into account your financial situation, objectives
and needs.
Before making any decision in relation to @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif or any products offered by @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif you should read the @if((App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->prospectus_text)) {{(App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->prospectus_text)}} @else Prospectus @endif and consider whether they are right for you. 
The @if((App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->prospectus_text)) {{(App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->prospectus_text)}} @else Prospectus @endif is available at the Project and Project Application Pages. 
...
@if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif accepts no liability for the content of this email, or the consequences of any actions taken on the basis of any information provided.
@if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif does not guarantee that this email and any attachment is secure, free of viruses or error-free.
The @if($siteTitle=App\Helpers\SiteConfigurationHelper::getConfigurationAttr($user->registration_site)->website_name){{$siteTitle}}@else Estate Baron @endif platform is operated by Tech Baron PTY LTD (ABN 67617252909) which is a Corporate Authorised Representative 001264952 of AFSL 275444). <a href="https://www.dropbox.com/s/gux7ly75n4ps4ub/Tech%20Baron%20AusFirst%20Financial%20Services%20Guide.pdf?dl=0">Financial Services Guide</a>.<br>
