        ...
        <div class='wrapper' style='clear:both;background-color:#e9e9e9;padding:2%;'>
          <div class='body' style='background-color:#e9e9e9;box-shadow: 5px 5px 2px #aaaaaa;max-width:100%;margin:0 auto;width:660px;clear:both;'>
            ...
            <div id='content' style='max-width:100%;padding:40px;background-color:#FFF;line-height:21px;'>
              ...
              <h2>Congrats {{$project->user->first_name}}</h2>
                            <p style ='font-size:15px;'>We have recieved expression of interest for your project <b>{{$project->title}}</b> from <b>{{$investor->first_name}} {{$investor->last_name}}</b>.<br>
                                Someone from our team will be getting in touch with you shortly to guide you through the investment process.</p>
