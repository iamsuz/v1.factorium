									...
									<div class="row" id="section-1">
										<div class="col-md-12">
											<div>
												...
												<input type="number" name="amount_to_invest" class="form-control" onkeypress="return isNumber(event)" placeholder="Minimum Amount A${{$project->investment->minimum_accepted_amount}}" style="width: 60%" id="apply_for" min="{{$project->investment->minimum_accepted_amount}}" step="1000" required value="@if(isset($eoi)) {{$eoi->investment_amount}} @endif">
