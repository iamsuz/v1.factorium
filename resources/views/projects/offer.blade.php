									...
									<div class="row" id="section-1">
										<div class="col-md-12">
											<div>
												...
												<input type="text" name="amount_to_invest" class="form-control" placeholder="5000" style="width: 60%" id="apply_for" required value="@if($eoi) {{$eoi->investment_amount}} @endif">
												...
												<input type="text" name="apply_for" class="form-control" placeholder="$5000" value="A$ @if($eoi) {{number_format(round($eoi->investment_amount, 2))}} @else 0.00 @endif" style="width: 60%" id="application_money">
