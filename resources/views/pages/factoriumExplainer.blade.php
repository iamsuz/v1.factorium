...
<div class="container text-center">
    ...
    <div id="explainer_carousel" class="carousel slide explainer-carousel" data-interval="false" data-wrap="false">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <img src="{{ asset('assets/images/explainer/f-21.png') }}">
                <h3>Before you buy invoices you need to load your account with AUDC, an Australian dollar backed stable coin which you can then use to transact on the platform</h3>
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/explainer/f-22.png') }}">
                <h3>In the near future we intend to completely decentralize our operations and replace AUDC with DAI and turn into a full non custodial solution. If crypto/blockchain intimidates you please do not worry, we intend to keep things simple. For now 1 AUDC = $1 Australian Dollar</h3>
            </div>
            <div class="item">
                <img src="{{ asset('assets/images/explainer/f-23.png') }}">
                <h3>You can buy AUDC using both cash or DAI. Once you login on your profile you will find the option to buy AUDC.
                </h3>
            </div>
            <div class="item">
        ...
        <div class="relative-items">
            ...
            <ol class="carousel-indicators explainer-carousel-indicators">
                ...
                <li data-target="#explainer_carousel" data-slide-to="20"></li>
                <li data-target="#explainer_carousel" data-slide-to="21"></li>
                <li data-target="#explainer_carousel" data-slide-to="22"></li>
            </ol>
