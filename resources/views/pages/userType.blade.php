        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <form action="{{ route('users.user.type.save') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-md-offset-2">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-xs-4">
                                    <input type="radio" name="user_type" id="user_type1" value="buyer" onclick="showUserTypeInfo('buyer')" @if($user->factorium_user_type) @if($user->factorium_user_type == 'buyer') checked @endif @else checked @endif>
                                    <h4><label for="user_type1" >Buyer</label></h4>
                                </div>
                                <div class="col-xs-4">
                                    <input type="radio" name="user_type" id="user_type2" value="seller" onclick="showUserTypeInfo('seller')" @if($user->factorium_user_type) @if($user->factorium_user_type == 'seller') checked @endif @endif>
                                    <h4><label for="user_type2" >Seller</label></h4>
                                </div>
                                <div class="col-xs-4">
                                    <input type="radio" name="user_type" id="user_type3" value="financier" onclick="showUserTypeInfo('financier')" @if($user->factorium_user_type) @if($user->factorium_user_type == 'financier') checked @endif @endif>
                    ...
                    <br>
                    <div>
                        <button class="btn btn-danger btn-lg">&nbsp;&nbsp; Go to Site &nbsp;<i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                            &nbsp;</button>
                    </div>
                </form>
            </div>
