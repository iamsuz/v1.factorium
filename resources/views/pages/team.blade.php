...
<section>
	<div class="chunk-box">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="heading-font-semibold second_color" style=" font-size:2.625em; color:#fed405; letter-spacing:3px;">@if($aboutus->founder_label) {{$aboutus->founder_label}} @else Founders @endif</h1>
					<br>
					@if($aboutus)
