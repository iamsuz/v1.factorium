    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action=" {{route('dashboard.investment.declareFixedDividend', [$project->id])}}" method="POST">
          {{csrf_field()}}
              <span class="declare-fixed-statement "><small>Issue Dividend at <input type="number" name="fixed_dividend_percent" id="fixed_dividend_percent" step="0.01" required> % </small></span>
