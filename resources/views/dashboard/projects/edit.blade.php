							...
							<div class="row text-center">
								<div class="col-md-12 wow fadeIn animated" data-wow-duration="1.5s" data-wow-delay="0.4s">
									...
									<div class="btn-group project-progress-3way-switch" data-toggle="buttons">
										...
										<label class="btn btn-default hide @if($project->is_coming_soon && !$project->is_funding_closed && !$project->eoi_button && $project->active) active @endif">
											<input type="radio" name="project_status" value="upcoming"> Upcoming
										</label>
										<label class="btn btn-default hide @if(!$project->is_coming_soon && $project->eoi_button && !$project->is_funding_closed && $project->active) active @endif">
									...
									<div class="row">
										<div class="col-md-2 col-md-offset-1 ">
											<span class="text-success pull-right">@if(($invoic_issuer->idDoc && $invoic_issuer->idDoc->verified == '1')||( $invoic_issuer->digitalIdKyc))<strong>Verified <i class="fa fa-check-circle" aria-hidden="true"></i></strong></span>@else <span class="text-danger">Not verified</span>@endif
										</div>
										<div class="col-md-3 ">
									...
									<div class="row">
										<div class="form-group @if($errors->first('description')){{'has-error'}} @endif">
											...
											{!!Form::label('invoice_issue_from_email', 'Invoice issued to Email id', array('class'=>'col-sm-2 control-label'))!!}
											<div class="col-sm-3">
									...
									<div class="row">
										<div class="form-group @if($errors->first('invoice_issued_from')){{'has-error'}} @endif">
											...
											{!!Form::label(null, 'Invoice issued from Email id', array('class'=>'col-sm-2 control-label'))!!}
											<div class="col-sm-3">
										...
										<form action="#" method="POST" name="tokenization_form">
											...
											<div class="row">
												...
												<div class="col-sm-6">
													...
													<input class="form-control" type="number" name="number_of_tokens" id="number_of_tokens" placeholder="Enter number of tokens to generate" required value="{{ (int)$project->investment->invoice_amount }}" max="{{ (int)$project->investment->invoice_amount }}">
												</div>
											</div>
											<br>
